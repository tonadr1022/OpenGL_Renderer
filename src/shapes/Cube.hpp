...
const std::vector<uint32_t> Indices = {0,  3,  1,  1,  3,  2,  4,  5,  7,  5,  6,  7,
                                       8,  9,  11, 9,  10, 11, 12, 15, 13, 13, 15, 14,
  ...
  if (scaleU != 1 || scaleV != 1) {
    ...
    for (auto& vert : Vertices) {
      scaledVertices.push_back(
          {vert.position, vert.normal, {vert.texCoords.x * scaleU, vert.texCoords.y * scaleV}});
    }
