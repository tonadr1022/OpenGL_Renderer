...
#ifndef OPENGL_RENDERER_SRC_CORE_HASHEDSTRING_HPP_
#define OPENGL_RENDERER_SRC_CORE_HASHEDSTRING_HPP_
...
// copied from: https://github.com/JuanDiegoMontoya/Gengine/blob/37739ecfcb608f6b282b36ed8a962fac968b1487/src/utility/HashedString.h
...
struct hash<HashedString> {
  std::size_t operator()(const HashedString& hs) const noexcept {
    return hs.value();
  }
};
...
#endif //OPENGL_RENDERER_SRC_CORE_HASHEDSTRING_HPP_
