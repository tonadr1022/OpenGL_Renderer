...
void ImGuiMenu::StartFrame(bool imguiFullScreen) {
  ...
  // from:
  // https://gist.github.com/PossiblyAShrub/0aea9511b84c34e191eaa90dd7225969 and
  // https://github.com/MorcilloSanz/RendererGL/tree/main

  // I didn't feel like learning this at the time I'm writing this, (want to
  // focus on rendering), will come back to it
  ...
  if (imguiFullScreen) {
    if (!use_padding) ImGui::PushStyleVar(ImGuiStyleVar_WindowPadding, ImVec2(0.0f, 0.0f));
    bool p_open = true;
    ImGui::Begin("DockSpace", &p_open, window_flags);
    if (!use_padding) ImGui::PopStyleVar();
