...
class ShaderManager {
 public:
  ...
  static Shader* AddShader(HashedString name,
 ...
 private:
  ...
  static bool CheckModuleCompilationSuccess(GLuint id,
                                            std::string_view shaderPath,
                                            ShaderType type);
  static uint32_t CompileModule(ShaderType type, const std::string& src,
